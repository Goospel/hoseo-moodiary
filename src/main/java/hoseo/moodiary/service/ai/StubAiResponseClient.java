 ...
 *
 * <p>end-to-end (Async 디스패치 → DB 상태 전이 → 폴링 응답) 검증용. 사용자 일기 내용과
...
public class StubAiResponseClient implements AiResponseClient {
    ...
    private static final String STUB_EMOTION = "neutral";
    private static final String STUB_HOME_COMMENT = "(stub) 홈 코멘트";

    @Override
    public AiInferenceResult invoke(UUID postId, String content, LocalDate diaryDate) {
        return new AiInferenceResult(STUB_CONTENT, STUB_EMOTION, STUB_HOME_COMMENT);
    }
}
