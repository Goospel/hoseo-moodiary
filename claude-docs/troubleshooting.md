...
>
> 마지막 갱신: 2026-05-28 (T-030 추가 — MkDocs strict 빌드의 두 번째 시운전에서 README 안의 `./claude-docs/X.md` 상대 링크들이 평면화된 사이트 디렉토리와 충돌. 빌드 시점에 README 의 모든 `./X` 상대 링크를 GitHub blob URL 로 외부화. T-029 의 README↔index 자동 충돌과 별개의 *directory contract 충돌*)
