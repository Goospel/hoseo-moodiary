...
>
> 마지막 갱신: 2026-05-28 (T-028 추가 — GitHub Pages deploy 트리거 브랜치 변경 시 `github-pages` environment 의 deployment branch allowlist 도 함께 업데이트해야 함. 트리거와 environment 는 독립된 두 게이트)
