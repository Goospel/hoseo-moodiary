...
>
> 마지막 갱신: 2026-05-29 (T-031 + T-032 추가 — release PR #79 운영 deploy 직후 발견된 두 함정. T-031: `@PathVariable AuthProvider` 의 case-sensitivity 가 silent 500 유발 / T-032: GlobalExceptionHandler 의 generic 핸들러가 stack trace 무로깅으로 진단 불가. 두 함정이 손잡고 나타나 진단을 어렵게 했다.)
