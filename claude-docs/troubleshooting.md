...
>
> 마지막 갱신: 2026-05-29 (T-033 추가 — T-032 의 교훈 4 ("silent 500 발견 = 다른 silent 함정도 의심") 를 sweep 으로 실행. 5건 catch 분석 → 2건 fix (AiResponseService @Async / HttpGoogleOAuth2Provider 네트워크) + 1건 의도적 침묵 명시 (JwtAuthenticationFilter high-volume).)
